...
crossover = ["local_crossover.o"]
mutation = ["decrease_mutation.o"]
replacement = ["general_replacement.o"]
stop = ["rate_stop_condition.o"]
common = "cost.o maxcut_local_variant.o common.o"
new_dir = sys.argv[1]
				...
				for st in stop:
					for se in selection:
						...
						for num in range(int(sys.argv[3]), int(sys.argv[3])+5):
							file_prefix = new_dir + "/" + g.split(".")[0] + "_binary_" + c.split("_")[0] + "_" + m.split("_")[0] + "_" + r.split("_")[0] + "_" + st.split("_")[0] + "_" + se.split("_")[0] + "_" + "VARIANT_S0.7_M0.3_N1000_K1_P00.51_P4_KF4_T0.7_C0.5"
